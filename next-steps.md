...
1. Modify or add environment variables to configure the running application. Environment variables can be configured by modifying the `env` node in the following files:
    - [app/chat-with-your-data-solution-accelerator.bicep](./infra/app/chat-with-your-data-solution-accelerator.bicep)
...
- [app/chat-with-your-data-solution-accelerator.bicep](./infra/app/chat-with-your-data-solution-accelerator.bicep) - Azure Container Apps resources to host the 'chat-with-your-data-solution-accelerator' service.
